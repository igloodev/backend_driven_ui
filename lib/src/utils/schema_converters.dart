    ...
    switch (value) {
      ...
      default:
        BduiLogger.warn(
          ...
          'Supported: home, search, settings, person, favorite, star, error, '
          'check, add, remove, close, edit, delete, share, copy, info, warning, '
          'lock, unlock, email, phone, message, camera, image, file, folder, '
          'download, upload, link, refresh, menu, back, forward, up, down.',
        );
